...
class erLhcoreClassModelChat {
   ...
   public function getState()
   {
       return array(
               ...
               'theme_id'    	        => $this->theme_id,
                ...
                'otro_motivo_cierre'   => $this->otro_motivo_cierre,
                'motivo_del_llamado'     => $this->motivo_del_llamado,
                'resolucion_del_llamado' => $this->resolucion_del_llamado,
                'producto_seleccionado'  => $this->producto_seleccionado,
                'modulo_seleccionado'    => $this->modulo_seleccionado,
   ...
   public $otro_motivo_cierre = '';
   public $motivo_del_llamado = '';
   public $resolucion_del_llamado = '';
   public $producto_seleccionado = '';
   public $modulo_seleccionado = '';
